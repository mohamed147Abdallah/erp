    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="glass-card p-12 text-center animate-fade-in-up">
                ...
                <p class="text-slate-500 dark:text-slate-400 mb-6">{{ __('messages.sales_returns_upcoming') }}</p>
                <a href="{{ route('sales.invoices.index') }}" class="btn-premium px-6 py-2 rounded-xl">{{ __('messages.back_to_invoices') }}</a>
            </div>
        </div>
    </div>
</x-app-layout>